...
begin
  if devData.First then begin
    ...
    AddItem('GL/freeglut.h','-lfreeglut -lwinmm');
    AddItem('GL/glut.h','-lfreeglut -lwinmm');
    AddItem('GL/glew.h','-lglew32 -lopengl32');
    AddItem('GLFW/glfw3.h','-lglfw3 -lgdi32');
    AddItem('wingdi.h','-lgdi32');
