...
type
  ...
  public
    function NewEditor(const Filename: String;AutoDetectUTF8:boolean; InProject, NewFile: boolean; PageControl: TPageControl = nil):
      TEditor;
...
function TEditorList.NewEditor(const Filename: String;AutoDetectUTF8:boolean; InProject, NewFile: boolean; PageControl: TPageControl =
  nil):
  TEditor;
var
