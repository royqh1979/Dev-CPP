...
type
  ...
  public
    ...
    procedure AddInts(Ints: TIntList);
...
procedure TIntList.AddInts(Ints: TIntList);
var
  I: Integer;
begin
  BeginUpdate;
  try
    for I := 0 to Ints.Count - 1 do
      AddObject(Ints[I], Ints.Objects[I]);
  finally
    EndUpdate;
  end;
end;
